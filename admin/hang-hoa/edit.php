...
$img_path = $UPLOAD_URL_2 . '/products/' . $hinh;
if (is_file($img_path)) {
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="index.php?btn_update" method="POST" enctype="multipart/form-data" id="update_hang_hoa">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-4">
                            <label>Hiểnt thị sản phẩm?</label>
                            <div class="form-control">
                                <label class="radio-inline  mr-3">
                                    <input type="radio" value="1" name="dac_biet" <?= $dac_biet ? 'checked' : '' ?>>Hiện 
                                </label>
                        ...
                        <!--div class="form-group col-sm-4">
                            ...
                            <div class="form-control">
                                <label class="radio-inline  mr-3">
                                    <input type="radio" value="1" name="hien_thi">Hiện
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" value="0" name="hien_thi" checked>Ẩn
                                </label>
                            </div>
                        </div!-->
